...
const Header = (_ref) => {
  ...
  const oauthUrl = `https://auth.monday.com/oauth2/authorize?client_id=6eb83b808f42f9f9b312be38a38ecb46&redirect_uri=http://localhost:3000/api/auth/monday/callback&scope=boards:read boards:write`;
  monday.setApiVersion("2023-10");
  const matchingSequence2 =
    /(?:loom\.com\/share\/|loom\.com\/embed\/)([a-zA-Z0-9]+)/;
  const defaultUrl = defaulturl;
  const id =
    defaultUrl === null ||
    defaultUrl === void 0 ||
    (_defaultUrl$match = defaultUrl.match(matchingSequence2)) === null ||
    _defaultUrl$match === void 0
      ? void 0
      : _defaultUrl$match[1];
  ...
  (0, _react.useEffect)(() => {
    ...
    monday.storage.instance.getItem("height").then((res) => {
      var _res$data3;
      const value =
        (_res$data3 = res.data) === null || _res$data3 === void 0
          ? void 0
          : _res$data3.value;
      console.log(value);
    ...
    monday.storage.instance.getItem("width").then((res) => {
      var _res$data4;
      const value =
        (_res$data4 = res.data) === null || _res$data4 === void 0
          ? void 0
          : _res$data4.value;
      console.log(value);
    ...
    monday.storage.instance.getItem("submitted").then((res) => {
      var _res$data6;
      const value =
        (_res$data6 = res.data) === null || _res$data6 === void 0
          ? void 0
          : _res$data6.value;
      console.log(value);
    ...
    monday.storage.instance.getItem("showEdit").then((res) => {
      var _res$data7;
      const value =
        (_res$data7 = res.data) === null || _res$data7 === void 0
          ? void 0
          : _res$data7.value;
      console.log(value);
    ...
    if (ifEditing) {
      monday.storage.instance.getItem("isEditing").then((res) => {
        var _res$data8;
        const value =
          (_res$data8 = res.data) === null || _res$data8 === void 0
            ? void 0
            : _res$data8.value;
        console.log(value);
  ...
  (0, _react.useEffect)(() => {
    if (storedurl) {
        ...
        if (iscanva && loomIdMatch[2] && loomIdMatch[1]) {
          ...
          setEmbedUrl(
            ""
              ...
              .concat(id)
              .concat(
                decodePart2 !== null && decodePart2 !== void 0
                  ? decodePart2
                  : ""
              )
          );
      ...
      setUrl(defaultUrl);
      const loomIdMatch =
        defaultUrl === null || defaultUrl === void 0
          ? void 0
          : defaultUrl.match(matchingSequence2);
      if (loomIdMatch && (loomIdMatch[1] || loomIdMatch[2])) {
        setEmbedUrl(
          "https://www.loom.com/embed/".concat(
            loomIdMatch[1],
            "?autoplay=false"
          )
        );
  ...
  (0, _react.useEffect)(() => {
    if (storedisEditing) {
      ...
      if (storedisEditing) {
        const loomIdMatch =
          url === null || url === void 0 ? void 0 : url.match(matchingSequence);
        if (loomIdMatch && (loomIdMatch[1] || loomIdMatch[2])) {
          if (iscanva && loomIdMatch[2]) {
            ...
            const id = loomIdMatch[1] || loomIdMatch[2];
            setEmbedUrl("".concat(decodePart1).concat(id, "/edit")) ||
              setEmbedUrl(
                "https://www.loom.com/embed/".concat(id, "?autoplay=false")
              );
          }
        }
      }
...
document.head.appendChild(styles);
  ...
  const handleUrlChange = (event) => {
    let inputUrl = DOMPurify.sanitize(event.target.value); // Sanitize the URL
    setUrl(inputUrl);
    monday.storage.instance.setItem("url", inputUrl);
    // localStorage.setItem('url', inputUrl) ;
    // setUrlSetting(false) ;
    const loomIdMatch =
      inputUrl === null || inputUrl === void 0
        ? void 0
        : inputUrl.match(matchingSequence);
    if (loomIdMatch && (loomIdMatch[1] || loomIdMatch[2])) {
      if (iscanva && loomIdMatch[2] && loomIdMatch[1]) {
        const embedId = loomIdMatch[2];
        setEmbedUrl(
        ...
        setEmbedUrl(
          ""
            ...
            .concat(id)
            .concat(
              decodePart2 !== null && decodePart2 !== void 0 ? decodePart2 : ""
            )
        );
      }
      // setShow(false);
  ...
  const handleWidthChange = (event) => {
    let value = parseInt(DOMPurify.sanitize(event.target.value), 10);
    
    // Ensure width does not exceed 1500
...
const handleHeightChange = (event) => {
  let value = parseInt(DOMPurify.sanitize(event.target.value), 10);
    ...
    // Ensure height does not exceed 1000
...
const toggleEditMode = async () => {
  try {
    // Fetch context (already contains user role info)
    const contextRes = await monday.get("context");
    console.log("Full Context Response:", contextRes);
    
    // Extract user details from context
    const user = contextRes.data?.user;

    if (!user) {
      console.log("User data not found in context.");
      return;
    }

    console.log("User ID:", user.id);
    console.log("Is View-Only:", user.isViewOnly);
    console.log("Is Guest:", user.isGuest);
    console.log("Is Admin:", user.isAdmin);

    // Apply logic based on user role
    if (user.isViewOnly || user.isGuest) {
      console.log("User is in view-only mode or a guest. Cannot edit.");
      return;
    }

    // If user is an Admin, allow toggling
    if (user.isAdmin) {
      ...
      if (slideIdMatch && slideIdMatch[1]) {
        setEmbedUrl(`${decodePart1}${slideIdMatch[1]}/${newEditMode ? "edit" : "preview"}`);
      }
    } else {
      console.log("Only Admins can edit.");
    }
  } catch (error) {
      ...
      /*#__PURE__*/ _react.default.createElement(
        ...
        /*#__PURE__*/ _react.default.createElement(
          ...
          /*#__PURE__*/ _react.default.createElement(
            "p",
            null,
            " We use cookies to enhance your user experience. By using our app, you agree to our use of cookies.",
            " "
          ),
          /*#__PURE__*/ _react.default.createElement(
            "p",
...
/*#__PURE__*/ _react.default.createElement("iframe", {
  ...
  width:
    /^\d+$/.test(String(width)) &&
    String(width).startsWith("0") &&
    width !== "0"
      ? 600
      : Math.max(600, Number(width) || 600),
  height:
    /^\d+$/.test(String(height)) &&
    String(height).startsWith("0") &&
    height !== "0"
      ? 400
  ...
  style: {
    ...
    showWarning &&
      /*#__PURE__*/ _react.default.createElement(
        ...
        "Invalid ",
        dashUrl,
        " URL. Please check the link and try again."
      ),
    /*#__PURE__*/ _react.default.createElement(
      "div",
      {
      ...
      /*#__PURE__*/ _react.default.createElement(
        ...
        /*#__PURE__*/ _react.default.createElement(
          ...
          /*#__PURE__*/ _react.default.createElement(
            ...
            "Explore additional resources to learn how to set up and utilize app."
          ),
          /*#__PURE__*/ _react.default.createElement(
            "button",
            {
        ...
        /*#__PURE__*/ _react.default.createElement(
          ...
          /*#__PURE__*/ _react.default.createElement(
            ...
            "Our dedicated team is available to assist you with any questions or concerns. Feel free to reach out!"
          ),
          /*#__PURE__*/ _react.default.createElement(
            "button",
            {
